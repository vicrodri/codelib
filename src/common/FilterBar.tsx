...
import { FilterActionType, Rating_Filter, SortingType } from "../utils/Utils";

interface FilterProps {
  isVisible: () => void;
}

export const FilterBar: FC<FilterProps> = ({ isVisible }: FilterProps) => {
              ...
              <li className='mt-1 mb-5'>
                ...
                <div className='flex items-center my-1'>
                  <input
                    ...
                    checked={state.sortBy === SortingType.LOW_TO_HIGH ? true : false}
                    onChange={() =>
                      dispatch({
                        type: FilterActionType.SORT_BY,
                        payload: { sortBy: SortingType.LOW_TO_HIGH },
                      })
                    }
                  />
                ...
                <div className='flex items-center my-1'>
                  <input
                    ...
                    name='price-sort'
                    className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600'
                    checked={state.sortBy === SortingType.HIGH_TO_LOW ? true : false}
                    onChange={() =>
                      dispatch({
                        type: FilterActionType.SORT_BY,
                        payload: { sortBy: SortingType.HIGH_TO_LOW },
                      })
                    }
                  />
              ...
              <li className='mt-1 mb-5'>
                ...
                <div className='flex items-center my-1'>
                  <input
                    ...
                    name='rating-sort'
                    className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600'
                    checked={state.ratings === Rating_Filter.MORETHAN4 ? true : false}
                    onChange={() =>
                      dispatch({
                        type: FilterActionType.RATINGS,
                        payload: { ratings: Rating_Filter.MORETHAN4 },
                      })
                    }
                  />
                ...
                <div className='flex items-center my-1'>
                  <input
                    ...
                    name='rating-sort'
                    className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600'
                    checked={state.ratings === Rating_Filter.MORETHAN3 ? true : false}
                    onChange={() =>
                      dispatch({
                        type: FilterActionType.RATINGS,
                        payload: { ratings: Rating_Filter.MORETHAN3 },
                      })
                    }
                  />
                ...
                <div className='flex items-center my-1'>
                  <input
                    ...
                    name='rating-sort'
                    className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600'
                    checked={state.ratings === Rating_Filter.MORETHAN2 ? true : false}
                    onChange={() =>
                      dispatch({
                        type: FilterActionType.RATINGS,
                        payload: { ratings: Rating_Filter.MORETHAN2 },
                      })
                    }
                  />
                ...
                <div className='flex items-center my-1'>
                  <input
                    ...
                    name='rating-sort'
                    className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600'
                    checked={state.ratings === Rating_Filter.MORETHAN1 ? true : false}
                    onChange={() =>
                      dispatch({
                        type: FilterActionType.RATINGS,
                        payload: { ratings: Rating_Filter.MORETHAN1 },
                      })
                    }
                  />
              ...
              <li className='mt-1 mb-5'>
                ...
                <div className='flex items-center my-1'>
                  <input
                    ...
                    onChange={() =>
                      dispatch({
                        type: FilterActionType.BEST_SELLER_ONLY,
                ...
                <div className='flex items-center my-1'>
                  <input
                    ...
                    onChange={() =>
                      dispatch({
                        type: FilterActionType.IN_STOCK_ONLY,
