...
export const OrderSuccess: FC<OrderProps> = ({ orderInfo }: OrderProps) => {
  return (
    <section className='text-xl text-center max-w-4xl mx-auto my-10 py-5 dark:text-slate-100 border dark:border-slate-700 rounded'>
      <div className='my-5'>
        ...
        <p>Thank you {orderInfo?.user.name} for the order!</p>
        <p>Your Order ID: {orderInfo?.id}</p>
      </div>
      <div className='my-5'>
        <p>Your order is confirmed.</p>
        <p>Please check your mail ({orderInfo?.user.email}) for the eBook.</p>
